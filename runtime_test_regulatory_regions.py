...
def main():
    ...
    if input_sample is not None:
        return match_regulatory_regions_vector(db, genome_reference, input_sample[0], input_sample[1], input_sample[2], input_sample[3])\
            if output_format == 'flat' else\
            match_regulatory_regions_matrix(db, genome_reference, input_sample[0], input_sample[1], input_sample[2], input_sample[3])
